        ...
        <RootSiblingParent>
            <BottomSheetModalProvider>
                <View style={styles.container}>
                    ...
                    >
                        <View style={styles.row}>
                            ...
                            >
                                <Octicons name="share" size={24} color={Colors.white} />
                ...
                <BottomSheetModal
                    ...
                    >
                    <View style={[styles.modalContainer, { paddingBottom: bottom, flex: 11 }]}>
                        <BottomSheetScrollView>
                            <View style={{ flex: 1 }}>
                        ...
                        <TouchableOpacity
                            style={[defaultStyles.btn, { backgroundColor: Colors.white, marginTop: 16 }]}
